...
from keras.optimizers import adam_v2, adagrad_v2
...
class DQNSolver:
    ...
    def __init__(self, observation_space, action_space):
        self.model = load_model("CNNPlayer.h5")
        self.GAMMA = 0.9
        ...
        #self.model.add(Conv2D(64, (4,4), input_shape=(6, 7, 1), activation="relu"))
        ...
        self.model.compile(loss="mse", optimizer=adagrad_v2.Adagrad(lr=self.LEARNING_RATE))
